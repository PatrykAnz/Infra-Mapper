...
const Dashboard = () => {
  ...
  const handleAddTask = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("Błąd podczas dodawania urządzenia:", err);
      setError("Nie udało się dodać urządzenia. Spróbuj ponownie.");
    }
  };
  return (
...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        {items.length === 0 && !error && <p>Brak urządzeń. Dodaj pierwsze urządzenie na mapę.</p>}
